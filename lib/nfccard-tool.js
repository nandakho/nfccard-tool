...
nfcCardTool.prototype.getHeaderRawValues = function(blocks0to6) {
  ...
  const moreThan255 = tagHeader[17]==255;
  ...
  const tagHeaderValues = {
    raw: {
      ...
      NDEFMessageHeader: {
        ...
        MESSAGE_LENGTH: moreThan255?((tagHeader[18]*256)+tagHeader[19]):tagHeader[17]
      }
    },
    ...
    string: {
      ...
      NDEFMessageHeader: {
        ...
        MESSAGE_LENGTH: utils.decimalToHexString(moreThan255?((tagHeader[18]*256)+tagHeader[19]):tagHeader[17])
      }
    }
...
nfcCardTool.prototype.getNDEFMessageLengthToRead = function() {
  return this.tagHeaderValues.raw.NDEFMessageHeader.MESSAGE_LENGTH + (this.tagHeaderValues.raw.NDEFMessageHeader.MESSAGE_LENGTH>255?4:2);
};
/**
 * STATES
...
nfcCardTool.prototype.parseHeader = function () {
  ...
  // Block 4
    ...
    lengthToReadFromBlock4: this.getNDEFMessageLength() + (this.getNDEFMessageLength()>255?4:2),
...
nfcCardTool.prototype.cleanNDEFMessage = function(NDEFRawMessage) {
  ...
  if(NDEFRawMessage[0] === 0x03) {
    NDEFRawMessageCleaned = NDEFRawMessage.slice(NDEFRawMessage[1]===0xFF?4:2);
  }
